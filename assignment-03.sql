...
SELECT question_id,COUNT(answer_id) AS "Số câu trả lời"
FROM answer
...
-- Nguyễn Minh Quốc 
SELECT SUBSTRING_INDEX("Nguyễn Minh Quốc"," ", 1);
SELECT SUBSTRING_INDEX("Nguyễn Minh Quốc"," ", 2);
...
SELECT *
FROM  account
WHERE full_name LIKE BINARY "D%o";
